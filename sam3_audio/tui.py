...
class AudioTUI(App):
    ...
    BINDINGS = [
        ...
        Binding("i", "mark_in", "in"),
        Binding("o", "mark_out", "out"),
        Binding("s", "save", "save"),
        Binding("d", "separate", "isolate"),
        Binding("question_mark,?", "help", "help"),
        Binding("q", "quit_app", "quit"),
        # Hidden — discoverable via ?
        Binding("right", "seek(5)", "+5s", show=False),
        Binding("left", "seek(-5)", "-5s", show=False),
        Binding("shift+right", "seek(1)", "+1s", show=False),
        Binding("shift+left", "seek(-1)", "-1s", show=False),
        Binding("plus,equals_sign,equal", "speed(0.1)", "speed+", show=False),
        Binding("minus", "speed(-0.1)", "speed-", show=False),
        Binding("v", "gain(3)", "vol+", show=False),
        Binding("V", "gain(-3)", "vol-", show=False),
        Binding("p", "play_fragment", "play fragment", show=False),
        Binding("g", "goto_frag_start", "go to start", show=False),
        Binding("G", "goto_frag_end", "go to end", show=False),
        Binding("x", "del_fragment", "delete", show=False),
        Binding("u", "undo_delete", "undo", show=False),
        Binding("S", "split_fragment", "split", show=False),
        Binding("m", "merge_fragments", "merge", show=False),
        Binding("left_square_bracket", "nudge_start(-0.1)", "in ←", show=False),
        Binding("right_square_bracket", "nudge_end(0.1)", "out →", show=False),
        Binding("left_curly_bracket", "nudge_start(0.1)", "in →", show=False),
        Binding("right_curly_bracket", "nudge_end(-0.1)", "out ←", show=False),
        Binding("D", "separate_all", "isolate all", show=False),
        Binding("ctrl+k", "cancel_separation", "cancel isolation", show=False),
        Binding("f", "open_file", "open file", show=False),
    ]
